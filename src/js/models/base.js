export const data = {
     ...
     player:null,
     seeking:0,
     poster:'./img/logo/Vision.png',
     get mobileAndTabletcheck(){
          let check = false;
     ...
     playbackSpeeds:[0.5, 1.0, 1.25, 1.50, 2.0, 2.5, 3.0],
     controls: {
          play: "true",
          seekBack: "true",
          seekFwd: "true",
      ...
      menuOpen:0,
      globalState:{
           // this is use for store all states for classes
      },
      timer:undefined ,// stores settimeout return 
      hide:true,
...
export const iconsName = {
     ...
     // @desc this object contains all the svg icons class that will use to draw buttions and other icons
    ...
    // FastForward:'icon-fast-forward-double-right-arrows-symbol1',
     //FastBackward:'icon-fast-backward-double-right-arrows-symbol',
